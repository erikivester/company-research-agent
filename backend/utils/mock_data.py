...
MOCK_RESEARCH_TEMPLATE = {
    ...
    "source_credibility": {
        ...
        "source_metrics": {"total_analyzed": 10, "relevant_sources": 8},
    },
            ...
            "results": [
                {
                    ...
                    "template_data": {
                        "official_content": {
                            "sustainability_reporting": MOCK_RESEARCH_TEMPLATE[
                                "official_content"
                            ]["sustainability_reporting"]
                        }
                    },
    ...
    if "results" in section_data:
        for result in section_data["results"]:
            ...
            result["template_data"]["source_credibility"] = {
                "reference_info": MOCK_RESEARCH_TEMPLATE["source_credibility"][
                    "reference_info"
                ],
                "source_metrics": MOCK_RESEARCH_TEMPLATE["source_credibility"][
                    "source_metrics"
                ],
            }
